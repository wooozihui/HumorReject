import json
def get_universal_manual_prompt(target_str, goal=''):
...
if __name__ == "__main__":
        all_data = json.load(open('data/mixbench.json','r'))
        print_num = 43
        instruction = all_data[print_num]['instruction']
        target = all_data[print_num]['target']
        print(get_universal_manual_prompt(target,instruction))
